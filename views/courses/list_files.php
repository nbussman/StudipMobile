...
{
    	?>
	<a href="<?= $controller->url_for("courses/dropfiles", htmlReady($seminar_id)) ?>" class="externallink" data-role="button" data-theme="b">Alle Dateien in meine Dropbox</a><br>
	<ul id="files" data-role="listview" data-filter="false" data-count-theme="b">
		<?
		foreach($files AS $file)
		{
			?>
			<li><a href="<?=$file["link"] ?>" class="externallink">
